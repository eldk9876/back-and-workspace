...
-- cname 컬럼 추가
    ...
    ALTER TABLE dept_copy ADD lname VARCHAR(20) DEFAULT '한국';
     ALTER TABLE department DROP COLUMN lname;
...
/*
	1-2 컬럼 수정 (MODIFY)
    - 자료형 변경 : ALTER TABLE 테이블명 MODYFY 컬럼명 변경할자료형;
    - 기본값 변경 : ALTER TABLE 테이블명 MODYFY 컬럼명 자료형 DEFAULT 변경할기본값;
...
/*
    ...
    -NOT NULL : MODIFY 컬럼명 [CONSTRAINT 제약조건명] NOTNULL;
*/
