...
public class F_Triple {
	...
	/*
	 * 실습문제 1
	 * 사용자한테 두 개의 정수값을 입력받아서 두 정수의 곱셈 결과 100 보다 크거나 같은 경우
	...
	public void practice2() {
		...
		String result = ( ch1 <= 'A' && ch1 <= 'Z'  ? "알파벳 대문자입니다." : "알파벳 대문자가 아니다.");
		System.out.println(result);
	...
	public void practice3() {
		...
		//sc.nextLine();
		/*
		String result = ( (num1 + num2) || (num1 - num2)  ?  (num1 + num2) || (num1 - num2) : "잘못 입력했습니다");
		System.out.println(result);*/
		...
		System.out.println(result);
		// 또 다른 발법 1: 조건문 사용 (이건 다음주 월요일!)
		if(op == '+'||op == '-') {System.out.printf("%d %c %d = %d", num1 , op, num2, op == '+'? (num1 + num2) : (num1 - num2) );}else{System.out.println("잘못 입력했습니다");}
	...
	//	System.out.printf("%d %c %d = %d", num1 , op, num2, op == '+'? (num1 + num2) : op == '-'? (num1 - num2) : "잘못 입력했습니다" );
