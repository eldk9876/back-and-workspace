 ...
 * - 컬랙션을 사용하면 데이터의 추가, 삭제, 정렬 등의 처리가 간단하게 해결되어
 ...
 * - 동기화 : 하나의 자원(데이터)에 대해 여러개의 스레드가 접근하여 할 때 
 * 			한 시점에서 하나의 스레드만 사용할 수 있도록 하는 것을 말한다.
 * 
 * */

// 제네릭스(노란 전구)  : 사용자가 타입 지정을 안해서 자동 타입 지정 ->  타입지정 <>
public class A_ArrayList {
	...
	public void method2() {
		...
		list.add(1, new Person("유제석", "논현동", 51));
		...
		System.out.println("리스트에 저장된 사람들의 평균 연령");
		int sum = 0;
	...
	public void method3() {
		...
		// 12. 내림차순 정렬(문자열 ) : sort 메서드를 통해서 오름차순 정렬 후 reverse 메서드를 호출하여 정렬
