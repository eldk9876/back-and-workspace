...
public class Application {
	 ...
	 * 현재 등록된 회원 수는 ~~명입니다.
	 * 1. 새 회원 등록 -> insertMenber()
	 * 2. 회원 정보 수정 -> updateMenber()
	 * 3. 전체 회원 정보 출력 -> printAll()
	 * 9. 끝내기 -> 프로그램 종료
	 * 그 외의 번호 -> 잘못 입력하셨습니다. 다시 입력해 주세요
	 * 메뉴 번호 :
	 * 
	 * */
...
//		  현재 등록된 회원 수는 ~~명입니다.
	...
	public void insertMember() throws RecordNotFoundException {
